...
Por ejemplo, si los valores de la serie son {5,2,2,8,−4,−1,2}{5,2,2,8,−4,−1,2} entonces las medias móviles con retardo 3 son: (5+2+2)/3, (2+2+8)/3, (2+8−4)/3, (8−4−1)/3, (−4−1+2)/3.
